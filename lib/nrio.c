...
/* ----------------------------------------------------------------- */
{
  ...
  write_bvector(v, nl, nh, "%4ld", complete_filename);
}
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
{
  static char complete_filename[256];
  sprintf(complete_filename, "%s/%s", path, filename);
  write_svector(v, nl, nh, "%4ld", complete_filename);
}
/* -------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------- */
{
  static char complete_filename[256];
  sprintf(complete_filename, "%s/%s", path, filename);
  write_usvector(v, nl, nh, "%4ld", complete_filename);
}
/* ---------------------------------------------------------------- */
...
/* ---------------------------------------------------------------- */
{
  static char complete_filename[256];
  sprintf(complete_filename, "%s/%s", path, filename);
  write_ivector(v, nl, nh, "%4ld", complete_filename);
}
/* ------------------------------------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------------------------------------ */
{
  static char complete_filename[256];
  sprintf(complete_filename, "%s/%s", path, filename);
  write_bmatrix(m, nrl, nrh, ncl, nch, "%4ld", complete_filename);
}
/* ------------------------------------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------------------------------------ */
{
  static char complete_filename[256];
  sprintf(complete_filename, "%s/%s", path, filename);
  write_smatrix(m, nrl, nrh, ncl, nch, "%4ld", complete_filename);
}
/* -------------------------------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------------------------------- */
{
  static char complete_filename[256];
  sprintf(complete_filename, "%s/%s", path, filename);
  write_usmatrix(m, nrl, nrh, ncl, nch, "%4ld", complete_filename);
}
/* --------------------------------------------------------------------------------------- */
